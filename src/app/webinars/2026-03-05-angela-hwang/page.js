...
export default function WebinarLandingPage() {
  ...
  const scrollToFinalCta = (source) => {
    void trackUserEvent("webinar_scroll_to_final_cta", {
      source,
  ...
  useEffect(() => {
    if (user && isClient) {
      trackUserEvent("webinar_page_viewed", {
        webinar_id: "2026-03-05-angela-hwang",
        webinar_name: "Opportunity Zone Marketing for Sponsors Raising Capital",
    ...
    <div className="relative w-full text-gray-900 dark:text-white">
          ...
          {isLoadingBanner ? (
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              <div className="relative w-[90%] h-[90%] rounded-2xl overflow-hidden">
                <Image
                  src={bannerImage}
                  alt="Opportunity Zone Marketing for Sponsors Raising Capital"
                  fill
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 lg:py-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Opportunity Zone <span className="font-semibold text-[#1e88e5]">Marketing</span> for Sponsors Raising Capital
          </motion.h1>
          ...
          >
            Sponsors in OZ deals: Learn the strategies that attract investors and boost your capital raising.
          </motion.p>
          ...
          >
            {[
              { icon: Megaphone, text: "Attract qualified accredited investors" },
              { icon: TrendingUp, text: "Boost your capital raising results" },
              { icon: Target, text: "Stand out from competing sponsors" }
            ].map((benefit, index) => (
          ...
          >
            100% Free • Practical tips you can immediately apply
          </motion.p>
        </div>
      </section>
            ...
            >
              <div className="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                <p className="font-bold text-gray-900 dark:text-white text-base sm:text-lg lg:text-xl mb-4">
                  The live webinar will feature Angela alongside Dr. Jeff Richmond from OZ Listings, offering direct access to proven marketing strategies and OZ platform leadership.
                </p>
                <p className="mb-4">
                  Join us online for an insightful webinar designed to help sponsors master the art of marketing within <span className="font-bold">Opportunity Zones</span>. Perfect for those looking to boost their capital raising game, this session covers practical tips and effective strategies to connect with investors and grow your projects.
                </p>
                <p className="mb-4">
                  Learn from <span className="font-bold text-[#1e88e5]">Angela S. Hwang</span>, Founder & Principal Consultant at RevGen Consulting, who has helped raise over <span className="font-bold">$150M in direct investments</span> since 2020. With more than 20 years of experience in marketing and business development across financial services, real estate, legal, and technology, Angela brings a wealth of expertise in scaling capital-raising results.
                </p>
                <p className="mb-4">
                  Don't miss out on learning how to navigate the unique landscape of <span className="font-bold">Opportunity Zone investments</span> from the comfort of your home! Whether you're a first-time fund sponsor or looking to scale your existing capital raising efforts, this session will give you the clarity, confidence, and strategy you need.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-blue-50 via-sky-50 to-blue-50 dark:from-blue-900/20 dark:via-sky-900/20 dark:to-blue-900/20 py-8 lg:py-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            {[
              {
                title: "Attracting Qualified Accredited Investors",
                description: "Proven strategies to identify, reach, and engage high-net-worth investors actively seeking Opportunity Zone opportunities",
                icon: UserCheck,
                highlight: "Investor Targeting"
              },
              {
                title: "Building Trust Through Content Marketing",
                description: "How to establish credibility and authority through educational content that resonates with sophisticated investors",
                icon: BookOpen,
                highlight: "Content Strategy"
              },
              {
                title: "LinkedIn & Digital Marketing for OZ",
                description: "Platform-specific tactics to amplify your reach and convert digital engagement into investment commitments",
                icon: Share2,
                highlight: "Digital Outreach"
              },
              {
                title: "Creating Compelling Investor Presentations",
                description: "The anatomy of pitch materials that close - from data rooms to executive summaries that capture attention",
                icon: FileText,
                highlight: "Pitch Perfect"
              },
              {
                title: "Nurturing Long-Term Investor Relationships",
                description: "Systems and touchpoints to maintain investor engagement throughout the fundraising cycle and beyond",
                icon: MessageSquare,
                highlight: "Relationship Building"
              },
              {
                title: "Positioning Your Fund in a Competitive Market",
                description: "Differentiation strategies to stand out when investors have multiple OZ options to choose from",
                icon: Target,
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 lg:py-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 max-w-4xl mx-auto font-light leading-relaxed">
              Learn from proven experts who are pioneering the next evolution of Opportunity Zone investing and capital raising.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 xl:gap-12">
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                <p className="text-gray-900 dark:text-white font-bold text-base sm:text-lg lg:text-xl text-center">
                  Dr. Jeff Richmond
                </p>
                <p className="text-[#1e88e5] font-medium text-center">
                  CEO and Founding Partner, <span className="font-bold">OZ Listings</span>
                </p>
                <p>
                  Dr. Jeff Richmond is the CEO and founding partner of OZ Listings, the premier marketplace for Opportunity Zone investing. With a decade of experience in real estate, capital strategy, and business development, Jeff bridges the gap between investors, developers, and OZ assets nationwide. His expertise lies in structuring tax-advantaged deals, driving investor engagement, and scaling systems that make OZ investing more transparent and accessible.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="text-center mb-4 sm:mb-6">
                <div className="relative w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 rounded-2xl overflow-hidden mx-auto mb-4 shadow-lg bg-gray-200 dark:bg-gray-700">
                  <Image
                    src="https://authenticate.ozlistings.com/storage/v1/object/public/oz_webinars/2026-03-05-angela-hwang/AngelaHwang.png"
                    alt="Angela S. Hwang"
                    fill
              ...
              <div className="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                <p className="text-[#1e88e5] font-medium text-center">
                  Founder & Principal Consultant, <span className="font-bold">RevGen Consulting</span>
                </p>
                <p>
                  Angela has more than 20 years of experience in marketing and business development. She has helped to raise over <span className="font-bold">$150M in direct investments</span> since 2020 and contributed to significant revenue growth for various tech startups since 2016. She has a wide array of experience across multiple industries including financial services, real estate, legal and technology. In 2021, Angela was selected as one of <span className="font-bold">40 Under 40</span> by Silicon Valley Business Journal for her marketing leadership.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-12 text-center">
            <motion.button
              onClick={() => handleOtherCtaClick('hosts-section-cta')}
              className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-4 sm:px-6 lg:px-8 xl:px-12 py-2 sm:py-3 lg:py-4 rounded-full font-semibold text-xs sm:text-sm lg:text-base xl:text-lg shadow-xl transition-all duration-300 group"
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
            >
              {isIcymi && recordingLink ? 'Watch Recording' : 'Register Now - Learn from the Experts'}
              <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 ml-2 inline-block group-hover:translate-x-1 transition-transform" />
            </motion.button>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto font-light leading-relaxed mb-6">
              This session is designed for anyone involved in raising capital for Opportunity Zone deals.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            {[
              { 
                icon: Building,
                title: "OZ Fund Sponsors", 
                description: "Learn how to attract investors and differentiate your fund in a competitive market" 
              },
              { 
                icon: Users,
                title: "Capital Raising Teams", 
                description: "Discover digital marketing strategies that generate qualified investor leads" 
              },
              { 
                icon: Briefcase,
                title: "Fund Managers & Developers", 
                description: "Master the art of communicating your value proposition to sophisticated investors" 
              },
              { 
                icon: Megaphone,
                title: "Marketing Professionals", 
                description: "Get proven tactics specific to the OZ and alternative investment space" 
              }
            ].map((attendee, index) => (
              <motion.div
                key={index}
          ...
          >
            ...
            >
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-900 dark:text-white max-w-4xl mx-auto font-bold">
                Don't miss out on learning how to navigate the unique landscape of Opportunity Zone investments.
              </p>
            </motion.div>
            ...
            <div className="text-gray-500 dark:text-gray-400">
              <p className="text-xs sm:text-sm lg:text-base font-light">100% Free • Practical tips you can immediately apply</p>
            </div>
          </motion.div>
        </div>
      </section>
