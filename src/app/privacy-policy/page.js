...
export default function PrivacyPolicyPage() {
  return (
    <div className="bg-white text-gray-800 dark:bg-black dark:text-white min-h-screen">
      <main className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none bg-gray-50 dark:bg-gray-900 p-8 rounded-2xl shadow-lg">
