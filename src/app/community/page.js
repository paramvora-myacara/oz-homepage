...
export default function CommunityPage() {
  ...
  return (
    <div className="relative w-full bg-white text-[#212C38] transition-colors duration-300 dark:bg-black dark:text-white">
      ...
      {/* Past Events Section */}
      <section id="past-events" className="relative pt-24 sm:pt-28 lg:pt-24 lg:min-h-screen lg:flex lg:items-center overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50/30 dark:from-gray-900 dark:via-slate-900 dark:to-blue-950/40"></div>
                  ...
                  <>
                    {pastEvents.map((event, index) => (
                      <Link 
                        ...
                        onClick={() => handlePastEventNav('banner')}
                      >
                        <motion.div 
                          className="absolute inset-0 rounded-lg sm:rounded-xl overflow-hidden group cursor-pointer" 
                          initial={{ opacity: 0 }}
