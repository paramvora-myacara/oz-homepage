...
import { createGenerationJob, ringDoorbell } from '@/lib/doc-processor'
...
export async function POST(
  ...
  // Doc-processor pipeline: durable job row first, then the best-effort
  // doorbell. Failure here never blocks the lifecycle transition.
