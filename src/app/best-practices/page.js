...
// Reveal-on-scroll animation variants consistent with other pages
const cardVariants = {
				...
				<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
						...
						<aside className="hidden lg:block lg:col-span-4 xl:col-span-3 order-2 lg:order-1">
							...
							<motion.div
								className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 shadow-lg"
								initial="hidden"
								whileInView="visible"
						...
						<motion.div
							className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg mb-6"
							initial="hidden"
							whileInView="visible"
							viewport={{ once: true, amount: 0.2 }}
							variants={cardVariants}
						...
						<motion.section
							id="thresholds"
							className="relative overflow-hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-8 shadow-xl mb-6"
							initial="hidden"
							whileInView="visible"
							viewport={{ once: true, amount: 0.2 }}
							variants={cardVariants}
						...
						<motion.div
							className="block lg:hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 shadow-lg mb-6"
							initial="hidden"
							whileInView="visible"
							viewport={{ once: true, amount: 0.2 }}
							variants={cardVariants}
						...
						>
							{/* Sponsor */}
							<motion.section id="sponsor" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
							...
							{/* Thesis */}
							<motion.section id="thesis" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants}>
							...
							{/* Underwriting */}
							<motion.section id="underwriting" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants}>
							...
							{/* Capital Stack */}
							<motion.section id="capital-stack" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants}>
							...
							{/* Risk */}
							<motion.section id="risk" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants}>
							...
							{/* OZ Done Right */}
							<motion.section id="oz" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants}>
							...
							{/* Operations */}
							<motion.section id="operations" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants}>
							...
							{/* Governance */}
							<motion.section id="governance" className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-7 shadow-lg" variants={cardVariants}>
							...
							<motion.section
								id="what-we-do"
								className="relative overflow-hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-8 shadow-xl"
								initial="hidden"
								whileInView="visible"
								viewport={{ once: true, amount: 0.2 }}
								variants={cardVariants}
