    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-6 py-4 border border-black/20 dark:border-white/20 rounded-2xl focus:ring-2 focus:ring-primary focus:border-primary bg-white/90 dark:bg-black/30 text-black dark:text-white text-lg placeholder-black/40 dark:placeholder-white/40 transition-all backdrop-blur-sm"
          disabled={isLoading}
        />
      </div>
    </div>
