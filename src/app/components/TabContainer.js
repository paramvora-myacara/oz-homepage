    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="w-full mb-8 animate-fadeIn">
        ...
        >
          ...
          <div
            className="absolute top-2 bottom-2 bg-primary rounded-2xl z-10 backdrop-blur-sm shadow-lg shadow-primary/20"
            style={sliderStyle}
          />
          ...
          {tabs.map((tab, index) => (
            <button
              ...
              className={`flex-1 px-6 py-3 rounded-2xl font-medium transition-all duration-300 relative z-20 hover:scale-[1.02] active:scale-[0.98] ${activeTabIndex === index
