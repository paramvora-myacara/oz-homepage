      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div className="lg:sticky lg:top-24">
                <div className="bg-gray-50 dark:bg-white/5 rounded-3xl p-8 md:p-10 text-navy dark:text-white relative overflow-hidden shadow-xl border border-gray-100 dark:border-gray-800">
