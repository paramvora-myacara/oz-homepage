              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {reason.highlights.map((highlight, idx) => (
                    <span
                      key={idx}
                      className={`inline-block px-3 py-1 md:px-3.5 md:py-1.5 rounded-2xl text-xs lg:text-sm font-semibold backdrop-blur-md transition-transform hover:scale-105 select-none ${reason.bulletColor}`}
                    >
                      {highlight}
                    </span>
                  ))}
