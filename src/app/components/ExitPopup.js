...
export default function ExitPopup({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="flex min-h-[260px] w-full max-w-xs flex-col justify-center rounded-xl border border-white/80 bg-white p-4 shadow-2xl sm:min-h-[380px] sm:max-w-md sm:p-8">
        <h1 className="mb-4 text-center text-lg font-extrabold text-[#ffffff] sm:mb-8 sm:text-2xl">
          You Love Taxes? Go Ahead and Close This Tab
        </h1>
        <h2 className="mb-3 text-center text-base font-semibold text-[#ffffff] sm:mb-6 sm:text-xl">
          Be the first to know when new Opportunity Zone deals drop
        </h2>
        <p className="mb-6 text-center text-sm text-[#ffffff] sm:mb-8 sm:text-base">
