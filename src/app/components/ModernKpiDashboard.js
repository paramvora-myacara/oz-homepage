    ...
    <div className="h-full px-3 md:px-8 pb-2 flex items-center justify-center">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-12 animate-fadeIn">
          ...
          <p className="text-xl md:text-2xl text-black/60 dark:text-white/60 font-light">
            ...
            {tabs.map(tab => {
              ...
              return (
                <button
                  ...
                  className={`px-3 md:px-6 py-3.5 rounded-full text-base md:text-lg font-medium transition-all flex items-center space-x-2.5 ${activeTab === tab.id
