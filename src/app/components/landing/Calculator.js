            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-8">
                ...
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                    ...
                    <div className="flex-[1.2] rounded-2xl p-6 flex flex-col relative min-h-[300px] sm:min-h-[400px]">
                        ...
                        <div className="flex-1 flex mt-16 mb-2 items-stretch">
                            {/* Y-Axis Labels */}
                            <div className="flex flex-col justify-between text-xs sm:text-sm font-bold text-navy/70 py-0 pr-2 sm:pr-4 text-right w-10 sm:w-16 h-full z-10">
                            ...
                            {/* Main Chart Area */}
                            <div className="flex-1 flex items-end justify-around gap-2 sm:gap-4 relative border-b-2 border-navy/10 min-h-[300px]">
                                {/* Grid Lines */}
                                ...
                                <div className="flex flex-col items-center w-full max-w-[100px] sm:max-w-[120px] relative z-20 h-full justify-end">
                                    ...
                                    >
                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 font-bold text-navy whitespace-nowrap text-xs sm:text-sm">
                                            {formatCompact(calculations.standardFinal)}
                                        </div>
                                    </motion.div>
                                </div>
                                ...
                                <div className="flex flex-col items-center w-full max-w-[120px] sm:max-w-[140px] relative z-20 h-full justify-end">
                                    <motion.div
                                        ...
                                        style={{
                                            height: `${(calculations.ozFinal / yMax) * 100}%`,
                                            scale: 1.05,
                                            originY: 1
                                        }}
                                    ...
                                    >
                                        <div className="absolute -top-12 left-1/2 -translate-x-1/2 font-black text-navy text-lg sm:text-xl whitespace-nowrap">
                                            {formatCompact(calculations.ozFinal)}
                                        </div>
                                        <div className="absolute top-4 left-1/2 -translate-x-1/2 rotate-90 origin-left text-white/20 text-2xl sm:text-4xl font-black select-none pointer-events-none">
                                            GROWTH
                                        </div>
                                    </motion.div>
                                </div>
                        ...
                        <div className="flex pl-10 sm:pl-12">
                            <div className="flex-1 flex justify-around gap-2 sm:gap-4">
                                ...
                                <div className="w-full max-w-[120px] sm:max-w-[140px] text-center">
                                    <span className="text-xs sm:text-sm font-bold text-primary uppercase tracking-widest whitespace-nowrap">With OZ Fund</span>
                                </div>
                            </div>
                        </div>
                    </div>
